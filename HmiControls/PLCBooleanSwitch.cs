...
{
    public partial class PLCBooleanSwitch : PLCControl<Boolean>
    {
        public PLCBooleanSwitch()
        {
            InitializeComponent();
        ...
        {
            this.plcBooleanOff.PLCValue = this._value;
            this.plcBooleanOn.PLCValue = this._value;
            this.plcBooleanOn.PLCDescription = this._descriptionOn;
            this.plcBooleanOff.PLCDescription = this._descriptionOff;
        }
